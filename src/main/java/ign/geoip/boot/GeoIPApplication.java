...
import ign.geoip.controllers.LegacyCountriesController;
...
public class GeoIPApplication extends DefaultResourceConfig {
    public GeoIPApplication() {
        super(CitiesController.class, CountriesController.class, LegacyCountriesController.class, AboutController.class);
