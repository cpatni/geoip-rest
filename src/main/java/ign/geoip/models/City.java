...
public class City {
    ...
    public String toXml() {
        StringBuilder sb = new StringBuilder().append("<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\"?>\n")
                ...
                .append("  <region_code>").append(escapeXml(regionCode)).append("</region_code>\n")
                .append("  <region_name>").append(escapeXml(regionName)).append("</region_name>\n")
                .append("  <country_code>").append(escapeXml(countryCode)).append("</country_code>\n")
                .append("  <country_name>").append(escapeXml(countryName)).append("</country_name>\n")
                .append("  <postal_code>").append(escapeXml(postalCode)).append("</postal_code>\n")
                .append("  <metro_code>").append(metroCode).append("</metro_code>\n")
                .append("  <metro_name>").append(escapeXml(metroName)).append("</metro_name>\n")
                .append("  <time_zone>").append(escapeXml(timeZone)).append("</time_zone>\n")
                .append("  <area_code>").append(areaCode).append("</area_code>\n")
    ...
    public String toJson() {
        StringBuilder sb = new StringBuilder()
                ...
                .append("\"region_code\": ").append(jsStringLiteral(regionCode)).append(", ")
                .append("\"region_name\": ").append(jsStringLiteral(regionName)).append(", ")
                .append("\"country_code\": ").append(jsStringLiteral(countryCode)).append(", ")
                .append("\"country_name\": ").append(jsStringLiteral(countryName)).append(", ")
                .append("\"postal_code\": ").append(jsStringLiteral(postalCode)).append(", ")
                .append("\"metro_code\": ").append(metroCode).append(", ")
                .append("\"metro_name\": ").append(jsStringLiteral(metroName)).append(", ")
                .append("\"time_zone\": ").append(jsStringLiteral(timeZone)).append(", ")
